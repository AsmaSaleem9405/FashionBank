      ...
      <div className="relative min-h-[calc(100vh-6rem)] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-12 relative z-10">
          ...
          <div className="flex flex-col items-start">
            ...
            <h1 className="text-4xl md:text-6xl font-['Cormorant_Garamond'] font-light text-[#3d1815] leading-tight mb-6">
              UNIFORMS <br />
              THAT DEFINE <br />
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
              <Link
                href="#collections"
                className="flex items-center justify-center gap-3 bg-[#3d1815] text-white px-8 py-4 rounded-full font-medium tracking-wide hover:bg-[#52221e] transition-all shadow-md group"
              >
          ...
          {/* Right Uniform Image Section with Floor Shadow */}
          <div className="relative flex justify-center items-center lg:justify-end">
            <div className="relative w-full max-w-[500px] h-[450px] md:h-[650px] -mb-12 flex items-end justify-center">
              
              {/* Floor Shadow to ground the mannequin */}
              <div className="absolute bottom-2 w-3/4 h-12 bg-black/10 blur-xl rounded-full z-0 pointer-events-none"></div>
